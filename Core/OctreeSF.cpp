...
void OctreeSF::GridNode::computeEdges(const Area& area, const SolidGeometry& implicitSDF, Vector3iHashGrid<SharedSurfaceVertex*> *sharedVertices, const bool ignoreEdges[3][LEAF_SIZE_3D])
{
	float stepSize = area.m_RealSize / LEAF_SIZE_1D_INNER;
	Ogre::Vector3 currentPos = area.m_MinRealPos;
	int index = 0;
